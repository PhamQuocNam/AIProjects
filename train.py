...
import argparse
import os
from utils.preprocessing import build_tokenizer, build_corpus, get_seq_len, term_vectorize, sentiment_vectorize, bert_tokenizer,\
    term_bert_vectorize, sentiment_bert_vectorize
from utils.dataset import Term_ABSADataset, Sentiment_ABSADataset, get_dataset
...
class Instructor:
    def __init__(self, opt):
        ...
        if 'bert' in opt.model_name:
            ...
            self.term_train_ds = Term_ABSADataset(train_ds, term_bert_vectorize ,self.tokenizer,self.opt.term_seq_len)
            self.sentiment_train_ds = Sentiment_ABSADataset(train_ds,sentiment_bert_vectorize, self.tokenizer,self.opt.sentiment_seq_len)
            
            self.term_val_ds = Term_ABSADataset(val_ds, term_bert_vectorize, self.tokenizer,self.opt.term_seq_len)
            self.sentiment_val_ds = Sentiment_ABSADataset(val_ds, sentiment_bert_vectorize ,self.tokenizer,self.opt.sentiment_seq_len)
            ...
            self.term_train_ds = Term_ABSADataset(train_ds, term_vectorize ,self.tokenizer,self.opt.term_seq_len)
            self.sentiment_train_ds = Sentiment_ABSADataset(train_ds,sentiment_vectorize, self.tokenizer,self.opt.sentiment_seq_len)
            
            self.term_val_ds = Term_ABSADataset(val_ds, term_vectorize, self.tokenizer,self.opt.term_seq_len)
            self.sentiment_val_ds = Sentiment_ABSADataset(val_ds, sentiment_vectorize ,self.tokenizer,self.opt.sentiment_seq_len)
